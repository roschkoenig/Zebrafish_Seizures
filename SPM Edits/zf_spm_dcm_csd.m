function DCM = zf_spm_dcm_csd(DCM)
%==========================================================================
% RR: adapted to call zf_spm_dcm_csd_data(DCM)
%==========================================================================
...
%--------------------------------------------------------------------------
y     = zf_spm_fs_csd(DCM.xY.y,DCM.M);
for i = 1:length(y)
    n      = size(y{i},1);
